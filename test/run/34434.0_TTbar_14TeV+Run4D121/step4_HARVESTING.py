...
# with command line options: step4 -s HARVESTING:@phase2Validation+@phase2+@miniAODValidation+@miniAODDQM --conditions auto:phase2_realistic_T35 --mc --geometry ExtendedRun4D121 --scenario pp --filetype DQM --era Phase2C22I13M9 -n 100 --filein file:step3_inDQM.root --fileout file:step4.root
...
process.barrelValidatorPostProcessor_step = cms.Path(process.barrelValidatorPostProcessor)
